...
export const DEFAULT_SITE_CONTENT: SiteContent = {
  home: {
    ...
    craftBand: {
      eyebrow: "The Asooda Way",
      title: "Honoring the Material, Respecting the Maker.",
      body: "Every piece at Asooda is born from a dialogue between the artisan and the wood. We source only sustainably harvested timber, allowing its natural character to guide the final form.",
      features: [
        {
  ...
  ourStory: {
    ...
    philosophy: {
      ...
      title: "The Asooda Way",
      body: [
        "At the heart of Asooda lies a commitment to the 'Asooda Way'—a standard of excellence that transcends modern convenience. We believe that furniture shouldn't just inhabit a room; it should anchor a legacy.",
